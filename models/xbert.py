...
class BertLayer(nn.Cell):
    ...
    def construct(self, hidden_states, attention_mask=None, head_mask=None):
        ...
        # 简化版，取消了原bert中的present_key_value = attention_outputs[-1]这一项，并没有加到最终的结果中
...
class BertConfig:
    ...
    def from_json_file(self, config):
        ...
        self.intermediate_size = bert_config['intermediate_size']
        self.layer_norm_eps = bert_config['layer_norm_eps']
        self.max_position_embeddings = bert_config['max_position_embeddings']
        self.model_type = bert_config['model_type']
        ...
        self.type_vocab_size = bert_config['type_vocab_size']
